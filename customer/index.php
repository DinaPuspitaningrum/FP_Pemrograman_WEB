...
<body>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>Popcorn Cake</h2>
				<p>Cake dengan Belgian Mouses Choco dan Topping Popcorn. </p>
			...
			<div class="da-slide">
				<h2>Lava Nutella</h2>
				<p>Cake coklat dengan lapisan selai Nutella.</p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<a href="produk.php" class="da-link">Lihat Produk</a>
			...
			<div class="da-slide">
				<h2>Thai Tea Boba Cake</h2>
				<p>Cake dengan saus Thai Tea dan topping Boba.</p>
	...
	<div id="wrapper">
    	...
    	<div class="container">
      	...
      	<div class="hero-unit">
        		<p>
                Homemade Cookies merupakan Online Shop yang menyediakan aneka cake, cookies, dessert box, dan kue ulang tahun. Available for Online Order. Delivery with Gojek & Cash on Delivery.
				</p>
				...
				<div class="icons-box-vert-container">
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Pesanan dikirim melalui GO-SEND. FREE delivery with min.order</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								<h3>Taste Good</h3>
								<p>Homemade Cookies menjamin rasa dan kualitas produk.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
				...
				<div class="span9">
					...
					<div id="footer-menu-links">
						...
						<ul id="footer-nav">
							...
							<li><a href="#">Free Delivery Min.Purchase 100k</a></li>
